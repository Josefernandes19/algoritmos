...
4) Faça um programa que leia um vetor vetor de 5 posições com o gabarito de uma prova, e outro vetor com as respostas do aluno. As respostas serão a, b, c, d ou e.
